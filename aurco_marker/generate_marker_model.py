...
class CreateAruco:
	...
	def create_marker(self):
		image = aruco.generateImageMarker(aruco_dict, self.marker_id, self.marker_pixel)
...
if __name__ == "__main__":
	...
	marker_pixel = 100
	marker_size = [0.005,0.050,0.050]
	border_pixel = 0
	path_to_save = "./models"
	aruco_gazebo = CreateAruco(aruco_dict,marker_pixel,border_pixel,marker_size,path_to_save)
	aruco_gazebo.create_and_save_multi_marker([i for i in range(2)])
